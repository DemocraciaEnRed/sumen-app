...
class FaqTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //------
        $faq = new Faq();
        $faq->title = '¿Qué es Partícipes + Sumen?';
        $faq->section = 'general';
        $faq->order = 1;
        ...
        //------
        $faq = new Faq();
        $faq->title = '¿Quíenes somos Partícipes + Sumen?';
        $faq->section = 'general';
        $faq->order = 2;
        ...
        $faq->section = 'general';
        $faq->order = 3;
        $faq->content = '<p>Partícipes+Sumen digital está dirigido a organizaciones de la sociedad civil y ciudadanía interesada y comprometida en el monitoreo ciudadano de las problemáticas públicas de sus ciudades, con el fin de generar incidencia.</p> <p><b>Informate</b> sobre monitoreos de políticas públicas realizados por organizaciones de la sociedad civil y ciudadanía de forma sencilla y colaborativa.</p> <p><b>Validá</b> la información sobre avances de metas o compromisos de gobierno, comentaá y sumate a comunidades temáticas.</p><p><b>Involucrate:</b> Conectate con otros actores de la sociedad civil y potencia tu capacidad de incidencia.</p>';
        $faq->save();
        //------
        $faq = new Faq();
