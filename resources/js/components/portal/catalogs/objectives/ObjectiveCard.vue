  ...
  <div class="card rounded shadow-sm">
    <div class="card-body">
      <div class="d-flex align-items-center">
        ...
        <div class="w-100">
          <p class="my-1 text-smaller" :style="`color:${objective.category.color}`"><i class="fa-fw d-inline-block d-md-none" :class="objective.category.icon" :style="`color: ${objective.category.color}`"></i> {{objective.category.title}} <span class="badge badge-success badge-pill ml-2" v-if="objective.completed"><i class="fas fa-check"></i>&nbsp;Completada</span></p>
...
export default {
  ...
  computed: {
    chartData: function(){
      return {
        labels: ['Alcanzados','En progreso','Demorado','Inactivos'],
        data: [
