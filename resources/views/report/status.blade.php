  ...
  <div class="card shadow-sm my-3">
    <div class="card-body p-3 p-lg-5 d-flex justify-content-between align-items-center">
      <div class="align-self-center animate__animated animate__flipInX">
        ...
        <p class="mb-0 mt-1">El reporte ha cambiado el estado de el proyecto de <span class="is-600 text-{{$report->previous_status}}"><i class="far fa-dot-circle"></i>&nbsp;{{$report->previous_status_label}}</span> a <span class="is-600 text-{{$report->status}}"><i class="far fa-dot-circle"></i>&nbsp;{{$report->status_label}}</span></p>
      </div>
