...
<section>
  <h3 class="is-700">Configuración de la proyecto</h3>
  <p class="lead">A continuación, encontrarás otras opciones de configuracion del proyecto</p>
  <hr>
  @if ($errors->any())
  ...
  @endif
  <h5 class="is-700 has-text-danger"><i class="fas fa-trash"></i> Eliminar proyecto</h5>
  <p>Al eliminar el proyecto, tenga en cuenta lo siguiente</p>
  <ul>
  ...
  <form action="{{ route('objectives.manage.goals.delete.form',['objectiveId' => $objective->id, 'goalId' => $goal->id]) }}" method="POST">
    ...
    <div class="form-group">
      ...
      <small class="form-text text-muted">Para poder eliminar el proyecto, ingrese su contraseña para confirmar.</small>
    </div>
    <div class="form-group">
     <label class="is-700 "><i class="fas fa-paper-plane"></i>&nbsp;Enviar notificación a suscriptores</label>
      ...
      @endif
      <small class="form-text text-muted">Se le enviará una notificación por sistema, de que el proyecto ha eliminada.</small>
    </div>
