...
<section>
  ...
  <form action="{{route('objectives.manage.goals.reports.edit.form',['objectiveId' => $objective->id, 'goalId' => $goal->id, 'reportId' => $report->id])}}" method="POST" enctype="multipart/form-data">
          ...
          <label>Estado del proyecto previo al reporte</label>
            <div class="form-group">
              <select class="custom-select" name="previous_status">
                  ...
                  <option value="delayed" {{$report->previous_status == 'delayed' ? 'selected' : null}}>Demorado</option>
          ...
          <label>Estado del proyecto luego del reporte</label>
            <div class="form-group">
              <select class="custom-select" name="status">
                  ...
                  <option value="delayed" {{$report->status == 'delayed' ? 'selected' : null}}>Demorado</option>
    ...
    <div class="alert alert-warning">
      <h6 class="is-700"><i class="fas fa-exclamation-triangle"></i> Importante</h6>
      Corrobore que, si cuenta con reportes de <i class="fas fa-fast-forward"></i> <b>avance</b> previos, y modifica el "Progreso de la pro antes del reporte" debe hacer las modificaciones pertinentes sobre reportes previos de avance, y sobre el valor del reporte en si. 
    </div>
    <div class="form-row">
      <div class="col">
        <div class="form-group">
    ...
    <div class="border border-light rounded p-3">
      ...
      @endif
      <small class="form-text text-muted">Se le enviará una notificación por sistema, de que el reporte ha sido editado invitandolos a verla.</small>
    </div>
    <br>
