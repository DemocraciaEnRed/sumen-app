...
<p class="my-1 text-smaller">Han editado el evento <b>{{$notification->data['event']['title']}}</b>, te notificamos porque el evento está relacionado con una meta al que estas suscripto. Podes ver mas acerca del evento haciendo <a href="{{route('events.index', ['eventId' => $notification->data['event']['id']])}}" >click aquí</a></p>
