...
<p>Es importante que verifique su correo electronico <b>{{Auth::user()->email}}</b> para que pueda:</p>
    <ul>
      ...
      <li>Para poder suscribirse a sus metas de interes y recibir notificaciones (de encontrarse habilitada la opcion de recibir por correo electrónico).</li>
      <li>Para poder formar parte de un equipo de algúna meta y participar de forma mas cercana.</li>
    </ul>
