<!-- Primary Meta Tags -->
<title>{{$event->title}} - {{app_setting('app_social_title',config('app.name', 'Laravel'))}}</title>
<meta name="title" content="{{$event->title}} - {{app_setting('app_social_title',config('app.name', 'Laravel'))}}">
...
<meta property="og:title" content="{{$event->title}} - {{app_setting('app_social_title',config('app.name', 'Laravel'))}}">
...
<meta property="twitter:title" content="{{$event->title}} - {{app_setting('app_social_title',config('app.name', 'Laravel'))}}">
