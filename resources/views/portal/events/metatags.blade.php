<!-- Primary Meta Tags -->
<title>{{$event->title}} - Sumen - Monitoreo Ciudadano</title>
<meta name="title" content="{{$event->title}} - Sumen - Monitoreo Ciudadano">
...
<meta property="og:title" content="{{$event->title}} - Sumen - Monitoreo Ciudadano">
...
<meta property="twitter:title" content="{{$event->title}} - Sumen - Monitoreo Ciudadano">
