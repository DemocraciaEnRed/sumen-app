...
@endphp
  ...
  @if($currentRoute == 'about.general')
    ...
    <scrollactive class="menu-link" active-class="is-active">
      ...
      @endforeach
      {{-- <a class="item-link scrollactive-item" href="#que-es">¿Qué es Sumen+Partícipes?</a>
      <a class="item-link scrollactive-item" href="#quienes-somos">¿Quiénes somos Sumen+Partícipes?</a>
