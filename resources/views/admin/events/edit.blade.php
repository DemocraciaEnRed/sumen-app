...
<section>
  ...
  <form method="POST" action="{{ route('admin.events.edit.form',['eventId' => $event->id]) }}" >
    ...
    <div class="border border-light rounded p-3">
      ...
      <small class="form-text text-muted">Se le enviará una notificación por email (si lo tienen habilitado) y por sistema a los suscriptores de las metas seleccionadas, de la edicion de los datos del evento invitandolos a verla.</small>
    </div>
    <br>
