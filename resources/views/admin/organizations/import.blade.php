...
<section>
  <h3 class="is-700">Importar organizaciones</h3>
  <p class="lead">Aqui se pueden importar organizaciones desde un archivo .xlsx</p>
  @if ($errors->any())
  ...
  @endif
   <div class="alert alert-warning">
    ...
    <p><a href="{{asset('files/base_import_organizations.xlsx')}}" target="_blank" class="btn btn-primary"><i class="fas fa-download"></i>&nbsp;Descargar planilla base</a></p>
    ...
    <table class="table table-bordered table-sm">
      ...
      <tbody>
       <tr>
         <td>Arboleada ONG</td>
         <td>Organizacion dedicada a criar y plantar arboles para ser insertados en la via publica (..)</td>
       </tr>
       <tr>
         <td>Semaforos ONG</td>
         <td>Organizacion dedicada a construir semaforos de forma personalizada (..)</td>
       </tr>
       <tr>
         <td>Señaleria ONG</td>
         <td>Establecida en 1950, Señaleria ONG. se dedica a la creacion de carteles de (..)</td>
       </tr>
    ...
    <form action="{{route('admin.organizations.import.form')}}" method="POST" enctype="multipart/form-data">
      @csrf
