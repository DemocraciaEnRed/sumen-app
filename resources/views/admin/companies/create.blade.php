...
<section>
  <h3 class="is-700">Crear empresa</h3>
  <p class="lead">Para crear una empresa, completa los siguientes campos:</p>
  @if ($errors->any())
  ...
  @endif
  <form method="POST" action="{{ route('admin.companies.create.form') }}" enctype="multipart/form-data">
    @csrf
