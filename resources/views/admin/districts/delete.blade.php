...
<section>
<h3 class="is-700">Eliminar distrito</small></h3>
<p class="lead">Complete los siguientes campos para eliminar un distrito:</p>
  ...
  @endif
  <form action="{{ route('admin.districts.delete.form',['districtId' => $district->id]) }}" method="POST">
    @method('DELETE')
    @csrf
    <p>Eliminar una distrito no tiene grandes impactos.</p>
